                    ...
                    <div className="laptop_content">
                        ...
                        <div className="selection">
                            <select name="cars" id="cars">
                                ...
                                <option value="saab">Casio </option>
                                <option value="mercedes">Apple </option>
                                <option value="audi">Mi Band </option>
                            </select>
                        </div>
                        <h3>Sản phẩm mới nhất</h3>
                        <hr />
                        <div className="row">
                            <ProductWatch image_laptop={Top_Laptop1}
                            ...
                            <ProductWatch image_laptop={Top_Laptop8}
                        ...
                        <div className="row">
                            ...
                            <ProductWatch image_laptop={Laptop_Sale4}
                                name_laptop="Dell Inspiron 5490 70196706 Silver"
                                price_laptop="20.990.000 ₫" />
                            <ProductWatch image_laptop={Laptop_Sale5}
                                name_laptop="Laptop HP Pavilion x360 NEW 2020 14-DW0060TU 195M8PA"
                                price_laptop="13.190.000 ₫" />
                            <ProductWatch image_laptop={Laptop_Sale6}
